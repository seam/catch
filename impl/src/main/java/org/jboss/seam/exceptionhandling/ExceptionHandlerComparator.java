...
/**
 * Comparator to sort exception handlers according to priority (highest number
 * first) then by class hierarchy of the Exception types being handled (most
 * specific first).
 */
public final class ExceptionHandlerComparator implements Comparator<ExceptionHandler>
{
    ...
    * the value of <i>expression</i> is negative, zero or positive.<p>
    * <p/>

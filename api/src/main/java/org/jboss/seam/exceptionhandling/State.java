 ...
 * in determining what to do with a particular exception handling. It may include and application
 * state, active processes, or other convenience methods for the {@link ExceptionHandler}
 * developer.
 * <p/>
 * For example, a servlet state may include methods to retrieve the HttpServletRequest, HttpServletResponse
